...
customElements.define('action-handler-mini-thermostat', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-mini-thermostat')) {
    return body.querySelector('action-handler-mini-thermostat') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-mini-thermostat');
